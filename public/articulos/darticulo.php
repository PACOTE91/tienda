...
<div class="card w-50" style="border-radius:20px;color:white;padding:10px;background: linear-gradient(90deg, rgba(2,0,36,0.5) 0%, rgba(9,9,121,0.5) 35%, rgba(0,212,255,0.5) 100%);">
    ...
    <img class="card-img-top" src="https://www.noegasystems.com/wp-content/uploads/Sistemas-de-almacenamiento-con-estanterias-para-palets.jpg" height=300 alt="Card image cap">
    <div class="card-body">

        <div style="width:40%;display:block;float:left">
            <p class="card-text"><b>NOMBRE </b><i class="fas fa-angle-double-right"></i> <?php echo $articulo->nombre ?></p>
            <p class="card-text"><b>PRECIO </b><i class="fas fa-angle-double-right"></i> <?php echo $articulo->precio ?>€</p>
            <p class="card-text"><b>CATEGORÍA </b><i class="fas fa-angle-double-right"></i> <?php echo $categoria->nombre ?></p>
        </div>
